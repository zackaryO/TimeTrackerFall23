...
db.serialize(() => {
    ...
    db.run(
        ...
        .run(
            `INSERT OR REPLACE INTO Users(userID, username, password, firstName, lastName, type, isActive, salt)
        SELECT (SELECT userID  -- This is allowed because if default admin account has been deleted, a new primary key will be assigned to the default admin account
            ...
            ), 'admin', '729698d2e7e3f792312a663f441767813c2e15465836f2c11300f9daafbd9fc36da0c0dc1e06c02e473e8fb76a8e58ad4673e9d833304ccaa733c2d667bb1fc1', 'sudo', 'admin', 'admin', true, '851d1de4be2b408af82cb83255136747'
        WHERE NOT EXISTS (
            SELECT userID
            FROM Users
